<%@ page import="lk.ijse.ecommerce_assignment_01.admin.CategoriesDTO" %>
    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav" style="display: inline">
                ...
                <li  ><a class="active"  href="category.jsp">Add Categories</a></li>
                <li><a  href="categoryVeiw">Categories List</a></li>
                <li><a class="active" href="#">Categories Update</a></li>
...
<div class="containers mt-5">
    <h1 class="text-center mb-4"><b>Update <span class="cat"> Category</span></b></h1>
    <form  action="category_update" method="post" class="shadow p-4 rounded bg-light forms">

        <!-- Category Name Field -->
        <div class="mb-3">
            <label for="categoryID" class="form-label">Category ID</label>
            <input type="text" id="categoryID" class="form-control" placeholder="Enter category ID" name="category_id" required>
        </div>
        <div class="mb-3">
            <label for="categoryName" class="form-label">Category Name</label>
            <input type="text" id="categoryName" class="form-control" placeholder="Enter category name" name="category_name" required>
        </div>
        <div class="mb-3">
            <label for="categoryDescription" class="form-label">Category Description</label>
            <input type="text" id="categoryDescription" class="form-control" placeholder="Enter category Description" name="category_Description" required>
        </div>


        <!-- Submit Button -->
        <button type="submit" class="btn btn-outline-secondary w-100 " id="btn_addCategory">Update Category</button>
    </form>
</div>
