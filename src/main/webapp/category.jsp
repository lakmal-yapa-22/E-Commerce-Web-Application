...
<div class="containers mt-5">
    <h1 class="text-center mb-4"><b>Add <span class="cat">Category</span></b></h1>
    <form  action="category" method="POST" class="shadow p-4 rounded bg-light forms">
        ...
        <!-- Submit Button -->
        <button type="submit" class="btn btn-outline-secondary w-100 " id="btn_addCategory">Add Category</button>
    </form>
</div>

<%--<div class="container mt-5">--%>
<%--    <h1 class="text-center mb-4"><b>Categories<span class="cat">List</span></b></h1>--%>
<%--    <%--%>
