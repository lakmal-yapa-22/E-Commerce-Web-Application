...
<nav id="navigation">
    ...
    <div class="container">
        ...
        <div class="container mt-5">
            <h1 class="text-center mb-4"><b>your <span class="cat">carts</span></b></h1>
            ...
            <!-- Product List Table -->
            <%
                List<ProductDTO> dataList = (List<ProductDTO>) request.getAttribute("carts");
...
<div class="container d-flex justify-content-center align-items-center vh-300">
    <form action="addtoCart" method="post" class="p-4 border rounded shadow-sm" style="width: 300px; background-color: #f8f9fa;">
