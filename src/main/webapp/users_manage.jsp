    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav" style="display: inline">
                ...
                <li><a class="active"  href="#">user manage</a></li>
...
<div class="container mt-5">
    <h1 class="text-center mb-4"><b>User <span class="cat">Manage</span></b></h1>
    <style>
        #body {
        ...
        .activeButton, #inactiveButton, .deactivateButton {
            color: white;
            padding: 10px 20px;
            border: none;
            cursor: pointer;
        ...
        .activeButton:hover, #inactiveButton:hover, .deactivateButton:hover {
            opacity: 0.8;
        }
        ...
        <div id="container">
            ...
            <table id="userTable">
                ...
                <tr>
                    <td>1</td>
                    <td>lakmal</td>
                    <td>lakmal2001yapa@gmail.com</td>
                    <td>customer</td>
                ...
                <tr>
                    ...
                    <td>admin</td>
                    <td><button class="deactivateButton">Deactivate</button></td>
                </tr>
                <tr>
                    <td>5</td>
                    <td>amal</td>
