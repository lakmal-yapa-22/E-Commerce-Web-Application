...
<div class="container mt-5">
    ...
    <form id="productForm" class="shadow p-4 rounded bg-light" action="adminHome" method="POST" enctype="multipart/form-data">
        <!-- Product Name Field -->
        <div class="mb-3">
        ...
        <!-- Submit Button -->
        <button type="submit" id="btn_addProduct" class="btn btn-outline-secondary w-100">Add Product</button>
    </form>
</div>
