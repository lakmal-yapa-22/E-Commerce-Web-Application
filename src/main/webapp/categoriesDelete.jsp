    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav" style="display: inline">
                ...
                <li><a class="active" href="#">Categories Delete</a></li>
...
<div class="containers mt-5">
    ...
    <form  action="categoriesDelete" method="post" class="shadow p-4 rounded bg-light forms">
        ...
        <!-- Submit Button -->
        <button type="submit" class="btn btn-outline-secondary w-100 " id="btn_addCategory">Delete Category</button>
    </form>
</div>
