    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav">
                ...
                <li><a href="user-details.jsp">user Detail</a></li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img style="height: 33%" src="./img/product07.png" alt="">
                    </div>
                    <div class="shop-body">
                        <h3>Smart Phone<br>Collection</h3>
                        <a href="phone" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    ...
                    <div class="shop-body">
                        ...
                        <a href="camera" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            <!-- /shop -->
...
<%--<img id="img_sale" src="img/new/sale.png">--%>
<iframe id="img_sale"  class="video" width="700" height="515"
        src="https://www.youtube.com/embed/pO6huJnV0Lw?autoplay=1&si=QSdhm-TaIeeH2cJq"
