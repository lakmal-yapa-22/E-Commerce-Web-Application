...
@WebServlet(name = "LaptopServelt", value = "/laptop")
public class LaptopServelt extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT id, name, price, quantity, description, product_image FROM products WHERE category_id = 1";
            ...
            req.setAttribute("laptop", productDTOList);
            RequestDispatcher rd = req.getRequestDispatcher("laptop.jsp");
            rd.forward(req, resp);
