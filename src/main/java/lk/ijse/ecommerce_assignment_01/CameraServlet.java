...
@WebServlet(name = "CameraServlet", value = "/camera")
public class CameraServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT id, name, price, quantity, description, product_image FROM products WHERE category_id = 3";
            ...
            req.setAttribute("camera", productDTOList);
