...
@WebServlet(name = "AllProductServlet", value = "/allProductVeiw")
public class AllProductServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "SELECT id, name, price, quantity, description, product_image FROM products ";
            ...
            req.setAttribute("all", productDTOList);
            RequestDispatcher rd = req.getRequestDispatcher("allProductVeiw.jsp");
            rd.forward(req, resp);
